...
const Hero = () => {
    return (
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-indigo-50 to-violet-50">
            ...
            <div className="container relative z-10 px-4 py-20 md:py-24">
                <div className="mx-auto max-w-4xl text-center">
                    <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-100 px-4 py-2">
                        <Zap className="h-4 w-4 text-indigo-600" />
                        <span className="text-sm font-medium text-indigo-700">Live & Real-time</span>
                    </div>

                    <h1 className="mb-6 text-5xl font-bold tracking-tight text-zinc-900 md:text-7xl lg:text-8xl">
                        <span className="bg-gradient-to-r from-indigo-600 to-violet-600 bg-clip-text text-transparent">Quizzy</span>
                    </h1>

                    <p className="mx-auto mb-10 max-w-2xl text-xl leading-relaxed text-zinc-600 md:text-2xl">
                    ...
                    <div className="flex flex-col justify-center gap-4 sm:flex-row">
                        ...
                        <Link
                            href="/leaderboard"
                            className="inline-flex items-center justify-center rounded-xl border border-indigo-200 px-8 py-4 text-lg font-semibold text-indigo-700 transition-colors hover:bg-indigo-50"
                        >
